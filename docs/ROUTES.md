...
| POST | /api/v1/admin/teams/:id/wallets/adjust |
...
| GET | /api/v1/admin/tenants/:id/auth-settings |
| HEAD | /api/v1/admin/tenants/:id/auth-settings |
| PUT | /api/v1/admin/tenants/:id/auth-settings |
| GET | /api/v1/admin/tenants/:id/rbac/permission-categories |
| HEAD | /api/v1/admin/tenants/:id/rbac/permission-categories |
| GET | /api/v1/admin/tenants/:id/rbac/permissions |
| HEAD | /api/v1/admin/tenants/:id/rbac/permissions |
| POST | /api/v1/admin/tenants/:id/rbac/permissions |
| DELETE | /api/v1/admin/tenants/:id/rbac/permissions/:permissionId |
| PUT | /api/v1/admin/tenants/:id/rbac/permissions/:permissionId |
| GET | /api/v1/admin/tenants/:id/rbac/roles |
| HEAD | /api/v1/admin/tenants/:id/rbac/roles |
| POST | /api/v1/admin/tenants/:id/rbac/roles |
| DELETE | /api/v1/admin/tenants/:id/rbac/roles/:roleId |
| PUT | /api/v1/admin/tenants/:id/rbac/roles/:roleId |
| GET | /api/v1/admin/tenants/:id/rbac/roles/:roleId/permissions |
| HEAD | /api/v1/admin/tenants/:id/rbac/roles/:roleId/permissions |
| POST | /api/v1/admin/tenants/:id/rbac/roles/:roleId/permissions |
| GET | /api/v1/admin/tenants/:id/rbac/users |
| HEAD | /api/v1/admin/tenants/:id/rbac/users |
| GET | /api/v1/admin/tenants/:id/rbac/users/:userId/access |
| HEAD | /api/v1/admin/tenants/:id/rbac/users/:userId/access |
| PUT | /api/v1/admin/tenants/:id/rbac/users/:userId/access |
| GET | /api/v1/admin/tenants/:id/users |
| HEAD | /api/v1/admin/tenants/:id/users |
| DELETE | /api/v1/admin/tenants/:id/users/:userId |
| GET | /api/v1/admin/tenants/:id/users/:userId |
| HEAD | /api/v1/admin/tenants/:id/users/:userId |
| POST | /api/v1/admin/tenants/:tenantId/users/:id/wallets/adjust |
...
| GET | /api/v1/admin/users/:id/summary |
| HEAD | /api/v1/admin/users/:id/summary |
...
| CONNECT | /api/v1/manual |
| DELETE | /api/v1/manual |
| GET | /api/v1/manual |
| HEAD | /api/v1/manual |
| OPTIONS | /api/v1/manual |
| PATCH | /api/v1/manual |
| POST | /api/v1/manual |
| PUT | /api/v1/manual |
| TRACE | /api/v1/manual |
| GET | /api/v1/manual/apps |
| HEAD | /api/v1/manual/apps |
| POST | /api/v1/manual/apps |
| DELETE | /api/v1/manual/apps/:app_id |
| GET | /api/v1/manual/apps/:app_id |
| HEAD | /api/v1/manual/apps/:app_id |
| PUT | /api/v1/manual/apps/:app_id |
| PUT | /api/v1/manual/apps/:app_id/permissions |
| PUT | /api/v1/manual/apps/:app_id/roles |
| GET | /api/v1/manual/apps/:app_id/stats |
| HEAD | /api/v1/manual/apps/:app_id/stats |
| PATCH | /api/v1/manual/apps/:app_id/status |
| GET | /api/v1/manual/oauth/clients |
| HEAD | /api/v1/manual/oauth/clients |
| POST | /api/v1/manual/oauth/clients |
| DELETE | /api/v1/manual/oauth/clients/:client_id |
| GET | /api/v1/manual/oauth/clients/:client_id |
| HEAD | /api/v1/manual/oauth/clients/:client_id |
| PUT | /api/v1/manual/oauth/clients/:client_id |
| POST | /api/v1/manual/oauth/clients/:client_id/regenerate-secret |
| POST | /api/v1/manual/oauth/clients/:client_id/revoke-tokens |
| GET | /api/v1/manual/oauth/clients/:client_id/stats |
| HEAD | /api/v1/manual/oauth/clients/:client_id/stats |
...
| HEAD | /api/v1/notifications/settings |
...
| GET | /api/v1/payment/webhook/stripe/events/:event_id |
| HEAD | /api/v1/payment/webhook/stripe/events/:event_id |
| CONNECT | /api/v1/plans |
| DELETE | /api/v1/plans |
| GET | /api/v1/plans |
| HEAD | /api/v1/plans |
...
| CONNECT | /api/v1/prices |
| DELETE | /api/v1/prices |
| GET | /api/v1/prices |
| HEAD | /api/v1/prices |
| OPTIONS | /api/v1/prices |
| PATCH | /api/v1/prices |
| POST | /api/v1/prices |
| PUT | /api/v1/prices |
| TRACE | /api/v1/prices |
...
| HEAD | /api/v1/s2s/teams |
| POST | /api/v1/s2s/teams |
| GET | /api/v1/s2s/teams/:id |
| HEAD | /api/v1/s2s/teams/:id |
...
| HEAD | /api/v1/s2s/users/:id/teams |
...
| GET | /api/v1/tenant/apps/:app_id/users/:user_id/roles |
| HEAD | /api/v1/tenant/apps/:app_id/users/:user_id/roles |
...
| HEAD | /api/v1/tenant/auth-settings |
...
| HEAD | /api/v1/tenant/cross-app-trusts/ |
...
| HEAD | /api/v1/tenant/cross-app-trusts/logs |
...
| GET | /api/v1/tenant/gift-cards/ |
| HEAD | /api/v1/tenant/gift-cards/ |
| GET | /api/v1/tenant/gift-cards/:code |
| GET | /api/v1/tenant/gift-cards/:code |
| HEAD | /api/v1/tenant/gift-cards/:code |
| HEAD | /api/v1/tenant/gift-cards/:code |
| POST | /api/v1/tenant/gift-cards/:id/invalidate |
| POST | /api/v1/tenant/gift-cards/batches |
...
| POST | /api/v1/tenant/liveness-check |
| GET | /api/v1/tenant/logs |
| HEAD | /api/v1/tenant/logs |
| GET | /api/v1/tenant/manual-api/keys |
| HEAD | /api/v1/tenant/manual-api/keys |
| POST | /api/v1/tenant/manual-api/keys |
| DELETE | /api/v1/tenant/manual-api/keys/:id |
...
| HEAD | /api/v1/tenant/oauth/scopes |
| POST | /api/v1/tenant/oidc/signing-keys/rotate |
...
| HEAD | /api/v1/tenant/stripe-config |
...
| HEAD | /api/v1/tenant/teams/:id/wallets |
| POST | /api/v1/tenant/teams/:id/wallets/adjust |
| POST | /api/v1/tenant/teams/:id/wallets/adjust |
...
| GET | /api/v1/tenant/tenants/:id/auth-settings |
| HEAD | /api/v1/tenant/tenants/:id/auth-settings |
| PUT | /api/v1/tenant/tenants/:id/auth-settings |
| GET | /api/v1/tenant/tenants/:id/rbac/permission-categories |
| HEAD | /api/v1/tenant/tenants/:id/rbac/permission-categories |
| GET | /api/v1/tenant/tenants/:id/rbac/permissions |
| HEAD | /api/v1/tenant/tenants/:id/rbac/permissions |
| POST | /api/v1/tenant/tenants/:id/rbac/permissions |
| DELETE | /api/v1/tenant/tenants/:id/rbac/permissions/:permissionId |
| PUT | /api/v1/tenant/tenants/:id/rbac/permissions/:permissionId |
| GET | /api/v1/tenant/tenants/:id/rbac/roles |
| HEAD | /api/v1/tenant/tenants/:id/rbac/roles |
| POST | /api/v1/tenant/tenants/:id/rbac/roles |
| DELETE | /api/v1/tenant/tenants/:id/rbac/roles/:roleId |
| PUT | /api/v1/tenant/tenants/:id/rbac/roles/:roleId |
| GET | /api/v1/tenant/tenants/:id/rbac/roles/:roleId/permissions |
| HEAD | /api/v1/tenant/tenants/:id/rbac/roles/:roleId/permissions |
| POST | /api/v1/tenant/tenants/:id/rbac/roles/:roleId/permissions |
| GET | /api/v1/tenant/tenants/:id/rbac/users |
| HEAD | /api/v1/tenant/tenants/:id/rbac/users |
| GET | /api/v1/tenant/tenants/:id/rbac/users/:userId/access |
| HEAD | /api/v1/tenant/tenants/:id/rbac/users/:userId/access |
| PUT | /api/v1/tenant/tenants/:id/rbac/users/:userId/access |
| GET | /api/v1/tenant/tenants/:id/users |
| HEAD | /api/v1/tenant/tenants/:id/users |
| DELETE | /api/v1/tenant/tenants/:id/users/:userId |
| GET | /api/v1/tenant/tenants/:id/users/:userId |
| HEAD | /api/v1/tenant/tenants/:id/users/:userId |
| POST | /api/v1/tenant/tenants/:tenantId/users/:id/wallets/adjust |
...
| DELETE | /api/v1/tenant/wallets/:id |
| GET | /api/v1/tenant/wallets/:id |
| GET | /api/v1/tenant/wallets/:id |
| HEAD | /api/v1/tenant/wallets/:id |
| HEAD | /api/v1/tenant/wallets/:id |
...
| POST | /api/v1/user/tenants/join-by-code/:code |
