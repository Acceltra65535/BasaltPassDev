          ...
          <div className="relative flex-1 flex flex-col max-w-xs w-full bg-white">
            ...
            <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
              <div className="flex-shrink-0 flex items-center gap-3 px-4">
                <img className="h-[1.6875rem] w-[1.6875rem] flex-shrink-0 object-contain" src={basaltPassLogoSymbol} alt="" aria-hidden="true" />
              ...
              <div className="flex w-full items-center justify-between">
                <div ref={mobileUserMenuRef} className="relative min-w-0 flex-1">
                  <PButton
                    ...
                    className="flex w-full min-w-0 items-center justify-start rounded-lg bg-white px-1 py-1 text-sm hover:bg-gray-50"
